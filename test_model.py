...
# take sepsis_cases_2, production and bpic2011_f3 for further analysis

for name in ['sepsis_cases_1', 'sepsis_cases_2', 'sepsis_cases_4', 'bpic2011_f1', 'bpic2011_f2', 'bpic2011_f3', 'bpic2011_f4', 'bpic2012_accepted', 'bpic2012_accepted', 'bpic2012_cancelled', 'production']:
    histplot_model_certainty(name, determine_columns_sel(name))
